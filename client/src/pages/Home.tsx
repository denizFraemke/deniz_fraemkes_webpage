    ...
    <section id="vita" className="mx-auto max-w-[1440px] px-[22px] pb-14 md:px-[64px] md:pb-24">
      ...
      <div>
        {milestones.map((t, i) => (
          <div
            key={t.period}
            className={`grid gap-2 py-5 md:grid-cols-[200px_1fr] md:gap-10 md:py-[26px] md:items-baseline ${
          ...
          >
            <div>
              ...
              {/* Coordinates (desktop only) — link to Google Maps */}
              <a
                href={t.mapsUrl}
                target="_blank"
                rel="noreferrer"
                className="hidden md:block mt-1.5 font-mono text-[10px] tracking-[1.5px] opacity-65 hover:opacity-100 hover:text-[#c88a4a]"
                style={{ color: TEAL }}
